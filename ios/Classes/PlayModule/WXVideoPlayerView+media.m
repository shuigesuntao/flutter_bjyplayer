...
@implementation WXVideoPlayerView (media)
...
- (void)setMediaCallbacks {
    ...
    [self.mediaControlView setScaleCallback:^(BOOL horizon) {
        ...
        [self updateConstriantsWithLayoutType:horizon? BJYPlayerViewLayoutType_FullHorizon : BJYPlayerViewLayoutType_Vertical];
    }];
    ...
    [self.mediaSettingView setSelectCallback:^(NSUInteger selectIndex) {
        ...
        else if (self.currentOptions == definitionList) {
